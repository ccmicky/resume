...
\section{Skills}
\cvline{Language}{C/C++, Java, Python, Shell, Haskell(little)}
\cvline{OS}{Windows, Linux, OS X(daily-work)}
\cvline{Version control}{Git, Svn}
\cvline{Android}{VM, Java Dev}
\cvline{Other}{Algorithm/Data Structure(enthusiastic), Vimer$\sim$}
